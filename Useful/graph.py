...
class graph:
    ...
    def isStronglyConnected(self):
        for i in range(0,len(self.adj)):
            for j in range(0,len(self.adj)):
                if i != j:
                    if not (self.connectivity(i,j) and self.connectivity(j,i)):
                        return False
        return True
    ...
    def isWeaklyConnected(self):
        for i in range(0,len(self.adj)):
            for j in range(0,len(self.adj)):
                if i != j:
                    if not (self.connectivity(i,j) or self.connectivity(j,i)):
                        return False
        return True
    ...
    def minimalSpanningTree(self,start):
        if not self.isStronglyConnected() or self.isDirected():
            return False
        #Prim's algorithm
        return True
